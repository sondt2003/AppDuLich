...
export default function CompassScreen(props) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ position: 'absolute', top: 230, left: 30, width: 322 }}>
            ...
            <TouchableOpacity style={{ position: 'absolute', top: 360, left: 30, width: 322 }} activeOpacity={0.8}>
            ...
            <View style={{ left: 0, position: 'absolute', top: 460 }}>
                <Text style={{ fontSize: 40, lineHeight: 52 }}>
                    Destination Gallery
                </Text>
            </View>
            <View style={{ borderColor: '#FF7757', borderBottomWidth: 3, width: "100%", top: 520,position:'absolute' }}></View>
            <View style={{ position: 'absolute', top: 540, left: 0 }}>
                <Text style={{ color: "#767E86", fontSize: 18 }}>
                    Our photo gallery on trip
                </Text>
            </View>
            <View style={{position:'absolute',top:560,width: '80%'}}>
