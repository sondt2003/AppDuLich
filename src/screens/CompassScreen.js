...
export default function CompassScreen(props) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ position: 'absolute', top: 190, left: 30, width: 322 }}>
            ...
            <TouchableOpacity style={{ position: 'absolute', top: 300, left: 30, width: 322 }} activeOpacity={0.8}>
            ...
            <View style={{ left: 20, position: 'absolute', top: 400 }}>
                <Text style={{ fontSize: 40, lineHeight: 52 }}>
                    Destination Gallery
                </Text>
            </View>
            <View style={{ borderColor: '#FF7757', borderBottomWidth: 3, width: "90%", top: 450,position:'absolute' ,left:20}}></View>
            <View style={{ position: 'absolute', top: 460, left: 20 }}>
                <Text style={{ color: "#767E86", fontSize: 18 }}>
                    Our photo gallery on trip
                </Text>
            </View>
            <View style={{position:'absolute',top:470,width: '80%'}}>
